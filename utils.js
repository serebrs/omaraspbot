...
exports.updateLog = async function (user_id, user_name, user_lastname = '') {
    ...
    try {
        ...
        await conn.query( { namedPlaceholders: true, sql: "INSERT INTO raspbot (user_id, user_name, user_lastname, last_datetime) VALUES (:id, :name, :lastname, :datetime) ON DUPLICATE KEY UPDATE user_name = :name, user_lastname = :lastname, last_datetime = :datetime" },
